...
# list_all_records.py is a script that is part of a Docker image solution for accessing the B2SHARE HTTP API.
# It lists all records that have been committed to a B2SHARE instance.
