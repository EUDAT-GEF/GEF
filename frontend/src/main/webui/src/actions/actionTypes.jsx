...
let actionTypes = {
    ...
    SELECT_VOLUME_START: 'SELECT_VOLUME_START',
    SELECT_VOLUME_SUCCESS: 'SELECT_VOLUME_SUCCESS',
    SELECT_VOLUME_EMPTY: 'SELECT_VOLUME_EMPTY',
    SELECT_VOLUME_ERROR: 'SELECT_VOLUME_ERROR',

    DOWNLOAD_VOLUME_FILE_START: 'DOWNLOAD_VOLUME_FILE_START',
    DOWNLOAD_VOLUME_FILE_SUCCESS: 'DOWNLOAD_VOLUME_FILE_SUCCESS',
    DOWNLOAD_VOLUME_FILE_ERROR: 'DOWNLOAD_VOLUME_FILE_ERROR',
};
