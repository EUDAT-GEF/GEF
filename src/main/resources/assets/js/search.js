...
var Results = React.createClass({displayName: "Results",
	...
	renderDiagnostics: function(corpusHit) {
		...
		return corpusHit.diagnostics.map(function(d) {
			return 	React.createElement("div", {className: "alert alert-warning", role: "alert", key: d.dgnUri}, 
						"Diagnostic: ", d.dgnMessage, " – ", d.dgnDiagnostic
					);
		});
	},
